...
const AreaSelection: React.FC<AreaSelectionProps> = ({ onAreaConfirmed }) => {
  ...
  }, [selectedDrain, catchments.length, selectedCatchments.length, setSelectedCatchments]);
    ...
    <div className="p-4 bg-white rounded-lg shadow-md">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
        {/* <MultiSelect
          ...
          label="Catchments"
          placeholder="All Auto-Selected"  // ✅ Updated placeholder
      ...
      <div className="mt-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
        ...
        <div className="space-y-2 text-sm text-gray-700">
          ...
          <p><span className="font-medium">Catchments:</span> {selectedCatchments.length > 0 ? `${selectedCatchments.length} (All Auto-Selected)` : "None"}</p>  {/* ✅ Updated display */}
