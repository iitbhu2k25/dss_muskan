...
const MapComponent = () => {
    const { mapInstance, mapContainerRef, popupRef, isLoading, error, featureInfo, setFeatureInfo, changeBaseMap } = useMap();
    ...
    useEffect(() => {
        if (mapInstance) {
            const timer = setTimeout(() => {
                ...
                mapInstance.renderSync(); // Ensure map renders
                ...
                {featureInfo && (
                    <>
                        ...
                        <div className="flex items-center justify-between mb-3 pb-2 border-b border-gray-200">
                            <h3 className="font-bold text-gray-800 text-base">{featureInfo.layerName}</h3>
                            <button
                                onClick={closePopup}
