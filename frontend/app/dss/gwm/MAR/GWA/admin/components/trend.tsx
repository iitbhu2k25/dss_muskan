        ...
        <div className="mb-4 p-3 bg-amber-50 border border-amber-200 rounded-md">
          <div className="flex items-start gap-2">
            ...
            <div className="text-sm text-amber-700">
              ...
              <p className="mt-1">Please select sub-districts in Step 1 before performing trend analysis.</p>
            </div>
          </div>
        </div>
      )}
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg p-4 grid grid-cols-2 md:grid-cols-4 gap-4">
                          ...
                          <div>
                            ...
                            <div className={`inline-flex items-center px-2 py-1 rounded-full text-xs font-medium ${villageData.trend_status === 'Increasing' ? 'bg-red-100 text-red-800' :
                        ...
                        <div className="bg-white border border-gray-200 rounded-lg p-6">
                          ...
                          <ResponsiveContainer width="100%" height={400}>
                            <LineChart data={chartData}>
                              ...
                              />
                              <YAxis
                                label={{ value: 'Groundwater Depth ', angle: -90, position: 'insideLeft', dy: 80 }}
                                domain={['auto', 'auto']}
                              />
                              <Tooltip
