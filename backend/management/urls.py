...
from .views import RegisterAdminView, LoginAdminView, LogoutAdminView, PersonalAdminListView,RegisterEmployeeView
...
urlpatterns = [
    ...
    path('register/employee', RegisterEmployeeView.as_view(), name="employee-register"),
]
