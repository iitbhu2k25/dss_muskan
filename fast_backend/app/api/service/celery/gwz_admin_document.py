...
@app.task(bind=True,pydantic=True,name="GWPZ_admin_document")
def document_gen4(self,payload: StpPriorityAdminReport):
...
@app.task(bind=True,pydantic=True,name="GWPZ_currency_image")
...
@app.task(bind=True,pydantic=True,name="GWPZ_admin_generation_start")
